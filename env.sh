...
export ENV_DATABASE_PORTS="3306:3306"
...
export ENV_DATABASE_EXPORTER_SERVER="database-exporter"
export ENV_DATABASE_EXPORTER_DATA_SOURCE_NAME="exporter:password@(${ENV_DATABASE_SERVER}:${ENV_DATABASE_PORT})/performance_schema"
export ENV_DATABASE_EXPORTER_PORT="9104"
export ENV_DATABASE_EXPORTER_PORTS="9104:9104"
